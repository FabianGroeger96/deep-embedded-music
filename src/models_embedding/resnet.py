...
class ResNet(BaseModel, ABC):
    ...
    def __init__(self, layer_params, resnet_type, params, model_name="ResNet"):
        """
        ...
        """
        super(ResNet, self).__init__(params=params, model_name=model_name, expand_dims=True)
...
class ResNet18(ResNet):
    ...
    def __init__(self, params, model_name="ResNet18"):
...
class ResNet34(ResNet):
    ...
    def __init__(self, params, model_name="ResNet34"):
...
class ResNet50(ResNet):
    ...
    def __init__(self, params, model_name="ResNet50"):
...
class ResNet101(ResNet):
    ...
    def __init__(self, params, model_name="ResNet101"):
...
class ResNet152(ResNet):
    ...
    def __init__(self, params, model_name="ResNet152"):
