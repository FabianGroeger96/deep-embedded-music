...
class ResNet(BaseModel, ABC):
    def __init__(self, layer_params, resnet_type, embedding_dim, model_name="ResNet"):
...
class ResNet18(ResNet):
    def __init__(self, embedding_dim, model_name="ResNet18"):
...
class ResNet34(ResNet):
    def __init__(self, embedding_dim, model_name="ResNet34"):
...
class ResNet50(ResNet):
    def __init__(self, embedding_dim, model_name="ResNet50"):
...
class ResNet101(ResNet):
    def __init__(self, embedding_dim, model_name="ResNet101"):
...
class ResNet152(ResNet):
    def __init__(self, embedding_dim, model_name="ResNet152"):
