...
def train_step(batch, model, loss_fn, optimizer):
    ...
    with tf.GradientTape() as tape:
        ...
        loss_neighbour = loss_fn.calculate_distance(anchor=emb_anchor, embedding=emb_neighbour)
        loss_opposite = loss_fn.calculate_distance(anchor=emb_anchor, embedding=emb_opposite)
    ...
    return triplet_loss, loss_neighbour, loss_opposite
